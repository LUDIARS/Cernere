...
| credential_generation | integer | NOT NULL, default 0。credential更新ごとに単調増加 |
...
launcherが生成してCernereへ渡した起動単位credentialの一方向検証履歴。
...
| client_secret_hash | text | NULL可。bcrypt一方向verifier |
| client_secret_encrypted | text | NULL可。migration 028以前のactive行を遅延移行するためのlegacy列 |
